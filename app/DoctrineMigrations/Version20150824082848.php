 ...
 */
class Version20150824082848 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE app_page (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, enabled TINYINT(1) DEFAULT NULL, asPopup TINYINT(1) DEFAULT NULL, content LONGTEXT NOT NULL, rawContent LONGTEXT NOT NULL, contentFormatter LONGTEXT NOT NULL, internalComment LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Links (page_id INT NOT NULL, linked_id INT NOT NULL, INDEX IDX_10438E1CC4663E4 (page_id), INDEX IDX_10438E1C56D691E4 (linked_id), PRIMARY KEY(page_id, linked_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE app_page_request (id INT AUTO_INCREMENT NOT NULL, page_id INT DEFAULT NULL, time DATETIME NOT NULL, userAgent VARCHAR(255) NOT NULL, remoteAddr VARCHAR(255) NOT NULL, INDEX IDX_3797E8BC4663E4 (page_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE Links ADD CONSTRAINT FK_10438E1CC4663E4 FOREIGN KEY (page_id) REFERENCES app_page (id)');
        $this->addSql('ALTER TABLE Links ADD CONSTRAINT FK_10438E1C56D691E4 FOREIGN KEY (linked_id) REFERENCES app_page (id)');
        $this->addSql('ALTER TABLE app_page_request ADD CONSTRAINT FK_3797E8BC4663E4 FOREIGN KEY (page_id) REFERENCES app_page (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Links DROP FOREIGN KEY FK_10438E1CC4663E4');
        $this->addSql('ALTER TABLE Links DROP FOREIGN KEY FK_10438E1C56D691E4');
        $this->addSql('ALTER TABLE app_page_request DROP FOREIGN KEY FK_3797E8BC4663E4');
        ...
        $this->addSql('DROP TABLE app_page_request');
